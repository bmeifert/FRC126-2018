...
public class AutoRightToLeft extends CommandGroup {

    public AutoRightToLeft() {
    	addSequential(new ZeroArms(), 10);
    	
    	addParallel(new ArmMovement(Arm.arm_position.arm_switch), 3.8);
    	addSequential(new DriveForward(), 3.8);
    	addSequential(new RotateDegrees(-90), 3);

    	addParallel(new ArmMovement(Arm.arm_position.arm_switch), 2.9);
    	addSequential(new DriveForward(), 2.9);
    	
    	addParallel(new ArmMovement(Arm.arm_position.arm_switch), 3);
    	addSequential(new RotateDegrees(-90), 3);
    	
    	addSequential(new ArmMovement(Arm.arm_position.arm_switch), 5);
    	...
    	addSequential(new ArmMovement(Arm.arm_position.arm_grab_cube), 1);
    	*/
